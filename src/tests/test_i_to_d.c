...
Suite *suite_insert(void) {
  ...
  tcase_add_test(tc, int_to_dec_22);
  tcase_add_test(tc, int_to_dec_23);
  tcase_add_test(tc, int_to_dec_24);
  tcase_add_test(tc, int_to_dec_25);
  tcase_add_test(tc, int_to_dec_26);
